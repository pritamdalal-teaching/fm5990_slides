...
- Let's suppose that the realized volatilty is $\sigma_{r}$ and the BSM for that volatility is $P_{r}$.
\vspace{10pt}
...
\vspace{10pt}
2. The PNL of a naked option position will have a higher variance than the PNL of it's delta-hedged counterpart.  But the PNL of the delta-hedged position is not zero.
\vspace{10pt}
